...
lmfit_2008<- lm(data=ames_raw_2008, ames_raw_2008$SalePrice ~ ames_raw_2008$`Gr Liv Area`+ ames_raw_2008$`1st Flr SF`+ ames_raw_2008$`Full Bath`)
```
...
Your code:
```{r,echo=TRUE}
lm2 <- lm(mpg ~ ., data = Auto[, sapply(Auto, is.numeric)])
summary(lm2)
```
...
Your code:
```{r,echo=TRUE}
lm_model<- lm(mpg ~ horsepower * weight, data = Auto)
